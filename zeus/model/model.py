...
from zeus.callbacks import CallbackRunner
from zeus.utils import AverageMeter


class Model(nn.Module):
    def __init__(self, *args, **kwargs):
        """
        Instead of inheriting from nn.Module, you import zeus and inherit from zeus.Model
        """
    ...
    def fit(
        ...
        for _ in range(epochs):
            ...
            if self.valid_loader:
                ...
                self.valid_loss_history.append(train_loss)
